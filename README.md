...
`Data Preparation` :  (refer [schema.sql](https://github.com/gitsparth29/walmart-sales-analysis/blob/main/walmart-sales-analysis/schema.sql))
...
`Feature Engineering` : (refer [schema.sql](https://github.com/gitsparth29/walmart-sales-analysis/blob/main/walmart-sales-analysis/schema.sql))
...
`Exploratory Data Analysis (EDA)` : (refer [solution.md](https://github.com/gitsparth29/walmart-sales-analysis/blob/main/walmart-sales-analysis/schema.sql))
